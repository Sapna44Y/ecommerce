...
function Footer() {
  return (
    <div className="bg-black text-white pt-5">
      {/* Footer content */}
      <div className="container mx-auto flex flex-col items-center space-y-8 md:space-y-0 md:flex-row md:justify-between px-12">
        {/* Exclusive section */}
        <div className="flex flex-col space-y-4 max-w-xs">
          ...
          <div className="flex items-center border border-white rounded overflow-hidden">
            <input
              className="p-2 flex-grow bg-transparent text-white placeholder-gray-400 outline-none"
